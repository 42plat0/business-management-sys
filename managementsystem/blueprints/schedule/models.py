...
class Date(db.Model):
    ...
    date = db.Column(
        db.String(10), default=func.current_date()  # Should be different - Date/Time
    )
...
class ShiftHours(db.Model):
    ...
    # Shift start time
    start_time = db.Column(db.String(10))  # Temporary, change!

    # Shift end time
    end_time = db.Column(db.String(10))  # Temporary, change!
